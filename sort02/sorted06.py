...
vendor_year_high_low = sorted(company_gear, key=byName)
vendor_year_high_low = sorted(vendor_year_high_low, key=byYear)
print("vendor year high low: ", vendor_year_high_low)
