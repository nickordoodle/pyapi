...
STORIES = 'http://gateway.marvel.com/v1/public/stories'
...
def marvelstoriescall(stampystamp, hashyhash, pkeyz, lookmeup):
    r = requests.get(STORIES + "?apikey=" + pkeyz + "&hash=" + hashyhash)

    print(STORIES + "?apikey=" + pkeyz + "&hash=" + hashyhash)
    return r.json()
...
def main():
    ...
    stories = marvelstoriescall(nightcrawler, cerebro, storm, args.hero)
